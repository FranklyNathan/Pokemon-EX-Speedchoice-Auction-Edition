const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]               ={{EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_KLEAVOR},
    ...
    [SPECIES_URSARING]              = {{EVO_LEVEL, 48, SPECIES_URSALUNA},
                                       {EVO_ITEM_HOLD, ITEM_HONEY, SPECIES_URSALUNA}},
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_MUNCHLAX]              = {{EVO_LEVEL, 30, SPECIES_SNORLAX},
                                       {EVO_ITEM_HOLD, ITEM_HONEY, SPECIES_SNORLAX}},
    ...
    [SPECIES_SPEWPA]                = {{EVO_LEVEL, 12, SPECIES_VIVILLON_OCEAN}},
    ...
    [SPECIES_SKRELP]                = {{EVO_ITEM_HOLD, ITEM_DRAGON_SCALE, SPECIES_DRAGALGE}},
    ...
    [SPECIES_NOIBAT]                = {{EVO_ITEM_HOLD, ITEM_RAZOR_FANG, SPECIES_NOIVERN}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_ITEM_HOLD, ITEM_KINGS_ROCK, SPECIES_DECIDUEYE_HISUIAN}},
    ...
    [SPECIES_SLIGGOO_HISUIAN]       = {{EVO_LEVEL_RAIN, 15, SPECIES_GOODRA_HISUIAN}},
