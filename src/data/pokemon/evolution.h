const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]               ={{EVO_ITEM_HOLD_DAY, ITEM_KINGS_ROCK, SPECIES_KLEAVOR},
                                     {EVO_ITEM_HOLD_NIGHT, ITEM_KINGS_ROCK, SPECIES_KLEAVOR},
                                     {EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_SCIZOR},
    ...
    [SPECIES_PORYGON]               = {{EVO_LEVEL, 18, SPECIES_PORYGON2}},
    ...
    [SPECIES_URSARING]              = {{EVO_LEVEL, 48, SPECIES_URSALUNA},
                                       {EVO_ITEM_HOLD_DAY, ITEM_HONEY, SPECIES_URSALUNA},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_HONEY, SPECIES_URSALUNA}},
    ...
    [SPECIES_STANTLER]              = {{EVO_MOVE, MOVE_CALM_MIND, SPECIES_WYRDEER}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                     {EVO_ITEM_HOLD_DAY, ITEM_METAL_COAT, SPECIES_SLIGGOO_HISUIAN},
                                     {EVO_ITEM_HOLD_NIGHT, ITEM_METAL_COAT, SPECIES_SLIGGOO_HISUIAN}},
    ...
    [SPECIES_NOIBAT]                = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NOIVERN}},
    ...
    [SPECIES_SNOM]                  = {{EVO_LEVEL, 26, SPECIES_FROSMOTH}},
    ...
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_LEVEL, 37, SPECIES_SLOWBRO_GALARIAN},
                                       {EVO_ITEM_HOLD_DAY, ITEM_KINGS_ROCK, SPECIES_SLOWKING_GALARIAN},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_KINGS_ROCK, SPECIES_SLOWKING_GALARIAN}},
