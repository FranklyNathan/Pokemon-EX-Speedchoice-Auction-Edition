...
const u8 gText_50CoinsAndPrice[] = _(" 500 COINS   ¥10,000");
const u8 gText_500CoinsAndPrice[] = _("1500 COINS  ¥30,000");
...
const u8 gText_TM32AndPrice[] = _("TM30{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM29AndPrice[] = _("TM29{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM35AndPrice[] = _("TM35{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM24AndPrice[] = _("TM24{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_TM13AndPrice[] = _("TM13{CLEAR_TO 0x48}1,500 COINS");
